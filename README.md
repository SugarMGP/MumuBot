...
- 🧩 **丰富工具集** — 内置工具覆盖发言、沉默、记忆检索、戳一戳、发表情包和网页浏览，并可通过 MCP 扩展
- 📝 **长期记忆** — 基于 pgvector 与 pg_trgm 统一检索事实、经历、偏好、群术语和表达方式
...
- 🖥️ **管理后台** — 按群查看知识与话题图谱，点击关联核对原文依据及启用、归档状态
- 📊 **健康检查接口** — 提供 `/health` 健康检查，方便接入部署和运维流程
